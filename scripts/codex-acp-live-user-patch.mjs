...
export const codexAcpLiveUserPatch = {
  id: "konteks-codex-acp-live-user-v4",
...
export function patchCodexAcpLiveUsers(source, version) {
  ...
  replaceOnce(
    ...
    if (konteksSession?.version === 1 && typeof konteksSession.title === "string" && konteksSession.title.startsWith("[konteks]") && konteksSession.title.length <= 160 && !/[\\p{Cc}\\p{Cf}]/u.test(konteksSession.title)) {
